package org.putegg.app.PhotoEgg.photopicker;
...
import org.putegg.app.PhotoEgg.photopicker.adapters.FolderAdapter;
import org.putegg.app.PhotoEgg.photopicker.adapters.PhotoAdapter;
import org.putegg.app.PhotoEgg.photopicker.beans.Photo;
import org.putegg.app.PhotoEgg.photopicker.beans.PhotoFolder;
import org.putegg.app.PhotoEgg.photopicker.utils.LogUtils;
import org.putegg.app.PhotoEgg.photopicker.utils.OtherUtils;
import org.putegg.app.PhotoEgg.photopicker.utils.PhotoUtils;
...
* */
    ...
    private AsyncTask getPhotosTask = new AsyncTask() {
        ...
        protected void onPreExecute() {
            ...
            System.out.println("ope is alive");
        }

        @Override
        protected Object doInBackground(Object[] params) {
            System.out.println("dib is start");
            mFolderMap = PhotoUtils.getPhotos(
                    PhotoPickerActivity.this.getApplicationContext());
            System.out.println("dib is alive");
            return null;
        }

        @Override
        protected void onPostExecute(Object o) {
            System.out.println("ope2 is start");
            getPhotosSuccess();
            System.out.println("ope2 is alive");
        }
    };
